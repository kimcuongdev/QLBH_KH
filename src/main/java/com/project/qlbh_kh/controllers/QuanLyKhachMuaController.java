...
public class QuanLyKhachMuaController implements Initializable {
    ...
    public void openCustomerOutList(int statisticType)
    {
        ...
        try
        {
            ...
            //nhap truy van
            PreparedStatement preparedStatement = connection.prepareStatement("{call dbo.customers_out_list(?)}");
    ...
    public void modifyCustomer(Customer selectedCustomer)
    {
        ...
        try
        {
            ...
            ChinhSuaKhachMuaController chinhSuaKhachHangController = fxmlLoader.getController();
